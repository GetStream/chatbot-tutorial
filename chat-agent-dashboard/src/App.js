...
import { MessageList,ChannelList, TypingIndicator, MessageInputFlat, MessageCommerce, MessageInput } from 'stream-chat-react';
...
const channels = chatClient.queryChannels(filters, sort, {watch: true, presence: true});
